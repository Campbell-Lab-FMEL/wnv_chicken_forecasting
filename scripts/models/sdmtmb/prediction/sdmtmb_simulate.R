...
#   wnv ~ 1 + poly(tmax_lag2, 2) + poly(prcp_lag1, 2) + poly(prcp, 2) + poly(tmin_lag2, 2) + testing + (1 | county) + (1 | ID),
#   time = "time_step",
#   extra_time = 16:19,
...
#   spatiotemporal = "ar1",
#   family = nbinom1(),
#   data = data_seasonal_active_train %>% st_drop_geometry())
...
#   wnv ~ 1 + poly(developed, 2) + poly(tmax, 2) + poly(prcp, 2) + poly(tmin_lag2, 2) + testing + (1 | county) + (1 | ID),
#   time = "time_step",
#   extra_time = 120:133,
...
#   spatiotemporal = "ar1",
#   family = nbinom1(),
#   data = data_monthly_active_train %>% st_drop_geometry())
